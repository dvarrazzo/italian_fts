...
PG_FUNCTION_INFO_V1(dinit_it_stem_latin1);
Datum dinit_it_stem_latin1(PG_FUNCTION_ARGS);

Datum 
dinit_it_stem_latin1(PG_FUNCTION_ARGS) {
	...
	d->z = italian_ISO_8859_1_create_env();
	if (!d->z) {
	...
	d->stem=italian_ISO_8859_1_stem;
